...
```bash
scp build/qrcode-zxing-1.0.0-1.deb recamera@192.168.42.1:/tmp/
```
...
sudo opkg install /tmp/qrcode-zxing-1.0.0-1.deb
```
...
```bash
qrcode-zxing /path/to/qr_code_image.png
```
